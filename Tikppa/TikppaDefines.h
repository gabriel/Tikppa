...
#define KBDebugAlert(DESC, WINDOW) ([[NSAlert alertWithError:[NSError errorWithDomain:@"Tikppa" code:-1 userInfo:@{NSLocalizedDescriptionKey:DESC}]] beginSheetModalForWindow:WINDOW ? WINDOW : [NSApp mainWindow] completionHandler:nil])

#define KBDebugAlertModal(DESC) ([[NSAlert alertWithError:[NSError errorWithDomain:@"Tikppa" code:-1 userInfo:@{NSLocalizedDescriptionKey:DESC}]] runModal])

#define KBTodoAlert() ([[NSAlert alertWithError:[NSError errorWithDomain:@"Tikppa" code:-1 userInfo:@{NSLocalizedDescriptionKey:@"TODO"}]] beginSheetModalForWindow:[NSApp mainWindow] completionHandler:nil])
